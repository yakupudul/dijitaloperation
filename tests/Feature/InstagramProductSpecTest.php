...
{
    private const BLUEPRINT = 'docs/product/instagram/INSTAGRAM.md';

    public function test_instagram_product_blueprint_exists_with_required_sections(): void
    {
        ...
        $this->assertStringContainsString('instagram', $contents);
    ...
    public function test_product_index_and_roadmap_map_instagram_to_blueprint(): void
    {
