...
final class ExternalWritesTest extends TestCase
{
    ...
    public function test_plugin_forces_drafts_and_refuses_published_content(): void
    {
        ...
        $this->assertStringContainsString("define('MOXDOP_CONNECTOR_VERSION', '1.2.0')", file_get_contents(base_path('connectors/wordpress/moxdop-connector/moxdop-connector.php')));
    }
