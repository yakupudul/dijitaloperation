...
{
    private const BLUEPRINT = 'docs/product/meta-ads/META_ADS.md';

    public function test_meta_ads_product_blueprint_exists_with_required_sections(): void
    {
        ...
        $this->assertStringContainsString('meta_ads', $contents);
    ...
    public function test_product_index_and_roadmap_map_meta_ads_to_blueprint(): void
    {
        ...
        $this->assertStringContainsString('| Meta Ads |', $index);
