...
/**
 * Meta Ads Agent + Skill assembly helpers for Meta Ads AI Guidance.
 *
 * Skill → required evidence mapping:
 * - account-performance-audit => meta_ads_account_summary
 * - campaign-performance-analysis => meta_ads_campaign_performance
 * - adset-delivery-analysis => meta_ads_adset_performance
 * - ad-creative-performance-analysis => meta_ads_ad_performance
 * - measurement-result-review => meta_ads_campaign_performance
 */
final class MetaAdsAgentSkillAssembler
{
