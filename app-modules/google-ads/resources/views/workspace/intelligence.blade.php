...
<div class="mox-website-workspace">
    <div class="mox-section-head">
        <div>
            ...
            <p class="mox-section-sub">Deterministic Findings and human-gated Recommendations. No external Ads writes.</p>
        </div>
    </div>
        ...
        <div class="mox-section-head mox-section-head--tight">
            <div>
                ...
                <p class="mox-section-sub">
                    {{ $ai['agent_name'] ?? 'Google Ads Analyst' }}
                    @if (! empty($ai['agent_version'])) · v{{ $ai['agent_version'] }} @endif
                    · {{ $ai['ai_route_name'] ?? 'Google Ads AI Guidance' }}
