 ...
 */
final class GoogleAdsAiRecommendationAcceptance
{
    /**
    ...
    public function acceptDraft(DigitalAsset $asset, int $findingId, ?Evidence $insight = null): array
    {
        if ($asset->type !== 'google_ads') {
            throw new InvalidArgumentException('AI recommendation acceptance requires a google_ads Digital Asset.');
        }

        $insight ??= app(GoogleAdsAiGuidanceService::class)->latestSuccessfulInsight($asset);
        ...
        if (! $finding instanceof Finding) {
            throw new InvalidArgumentException('Finding not found for this Google Ads asset.');
        }
