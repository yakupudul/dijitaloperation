...
/**
 * Website Agent + Skill assembly helpers for Website AI Guidance.
 */
final class WebsiteAgentSkillAssembler
{
    ...
    public function assemble(AgentProfileDefinition $profile, array $evidenceTypes, array $contextFlags = []): array
    {
        ...
        // recommendation-framing should still run if Findings exist even when others are ineligible.
