...
Evidence types (normalized): `google_ads_account_summary`, `google_ads_campaign_performance`, `google_ads_landing_final_urls`, `google_ads_search_term_performance`, `google_ads_conversion_actions`. Intelligence details: `GOOGLE_ADS_INTELLIGENCE.md`.
