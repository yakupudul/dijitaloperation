...
| AI Control Plane | `docs/product/AI_CONTROL_PLANE.md` — **AI Router + Agent/Skill V1 IMPLEMENTED**; Capability Router / Playbooks **PLANNED** |
| Agent + Skill architecture | `docs/product/AGENT_SKILL_ARCHITECTURE.md` (**IMPLEMENTED V1**) |
| Discovery Intelligence / Outside-in (planned) | `docs/product/DISCOVERY_INTELLIGENCE.md` (**NOT IMPLEMENTED**) |
