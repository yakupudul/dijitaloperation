...
| 4 – Entegrasyonlar (E1–E4) 🟡 (2026-10-07 kontrolünde kısmen; kalanlar Faz 12–14) | E1 hatalar/güvenlik; E2 kendi kendini onaran akış (yeniden bağlanınca devam, günlük yeniden deneme, token süre uyarısı, zamanlayıcı/işçi izleme, deploy kontrolleri); E3 tek merkez + tek kalıp; E4 veri seti tazeliği, backfill, maliyet ekranı, eklenti sürüm takibi |
...
| 14 – Strateji boşlukları ✅ | Consent Mode / CMP tespiti ve dönüşüm düşüşü / çift sayım uyarıları, Google Ads RSA metinlerinde uyum denetimi + 5 yeni sektör paketi taslağı, GBP yorum yanıt taslağı (tıkla, beğenilen örnekler, maliyet tahmini, yanıt hızı), yedekten geri yükleme komutu, Meta Lead Ads webhook'u ve bilinmeyen WhatsApp numaraları ajans talep kutusuna, tercih edilen toplama saati, veri seti kapsamı, DataForSEO marka limitleri maliyet ekranında, sağlam günlük anomali (medyan/MAD + EWMA kayma), kanallar arası bütçe kaydırma testi, sezon yaklaşıyor uyarısı, Açık artırma analizi CSV yükleme |
