...
| Google Integration hub/detail (`/app/integrations`) | REAL (backend state) | Prompt 13+14: Core* + production OAuth lifecycle; discovery/bind/collect still PARTIAL (15–19) |
