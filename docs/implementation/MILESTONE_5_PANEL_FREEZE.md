...
| Work | PARTIAL | Demo Tasks/reviews/approvals/QA remain; Client Request rows in Work are production DB-backed (Prompt 42). Broader Work/Task alignment owned by Prompt 43 |
