...
<div class="space-y-5" @if($run && in_array($run->status, ['queued', 'running'])) wire:poll.5s @endif>
    <section class="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
        <div class="flex flex-wrap items-start justify-between gap-4">
            <div><h2 class="text-lg font-semibold text-gray-900 dark:text-white">Standartlar</h2><p class="mt-2 max-w-3xl text-sm text-gray-500">Saklı web sitesi verilerini değerlendirir; teknik eksikleri, hizmet kapsamını ve ilgili sayfaları bir araya getirir. Kaynak veriyi güncelledikten sonra yeniden çalıştırın.</p></div>
