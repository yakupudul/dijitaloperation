@php
    ...
    $enumLabel = static function (string $group, ?string $value): string {
        ...
        return $value !== '' && \Illuminate\Support\Facades\Lang::has('operator_website.'.$group.'.'.$value)
...
<div class="space-y-5">
    ...
    <nav class="flex gap-1 overflow-x-auto border-b border-gray-200 dark:border-gray-800" aria-label="{{ __('operator_website.nav_label') }}">
