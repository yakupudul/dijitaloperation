<div class="flex flex-wrap gap-2">
    ...
    <a href="{{ route('demo.activity', ['asset' => \App\Support\Demo\DemoCatalog::WEBSITE_ASSET_ID]) }}" wire:navigate
        class="inline-flex items-center justify-center rounded-lg px-3 py-2 text-sm font-medium text-gray-700 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:text-gray-300 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
        {{ __('operator.website.actions.view_activity') }}
    </a>
    <a href="{{ route('demo.files', ['scope' => 'digital_asset', 'asset' => \App\Support\Demo\DemoCatalog::WEBSITE_ASSET_ID]) }}" wire:navigate
        class="inline-flex items-center justify-center rounded-lg px-3 py-2 text-sm font-medium text-gray-700 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:text-gray-300 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
    ...
    <details class="relative">
        ...
        <div class="absolute right-0 z-20 mt-2 w-56 rounded-xl bg-white p-2 shadow-lg ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-700">
            ...
            <a href="{{ route('demo.brand', ['brand' => \App\Support\Demo\DemoCatalog::BRAND_ID, 'tab' => 'business', 'business' => 'discovery']) }}" wire:navigate class="block rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/[0.04]">Discover public context</a>
            ...
            <a href="{{ route('demo.asset.create', ['brandId' => \App\Support\Demo\DemoCatalog::BRAND_ID]) }}" wire:navigate class="block rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/[0.04]">Edit Website</a>
