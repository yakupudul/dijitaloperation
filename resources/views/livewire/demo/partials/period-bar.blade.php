@php
    ...
    $maxDate = method_exists($this, 'periodPickerMaxDate') ? $this->periodPickerMaxDate() : \App\Support\Demo\DemoPeriod::ANCHOR_DATE;
    $minDate = method_exists($this, 'periodPickerMinDate') ? $this->periodPickerMinDate() : \Carbon\Carbon::parse(\App\Support\Demo\DemoPeriod::ANCHOR_DATE)->subDays(89)->toDateString();
@endphp
