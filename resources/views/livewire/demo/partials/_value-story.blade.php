...
<div class="space-y-4">
    ...
    <section class="rounded-xl bg-white p-4 ring-1 ring-inset ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
        ...
        @if (($story['empty_sections']['findings'] ?? false) || (($story['observations'] ?? []) === []))
            <p class="mt-3 text-sm text-gray-500">No Findings were recorded for this period.</p>
        @else
    ...
    <section class="rounded-xl bg-white p-4 ring-1 ring-inset ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
        ...
        @if (($story['empty_sections']['completed_work'] ?? false) || (($story['completed_work'] ?? []) === []))
            <p class="mt-3 text-sm text-gray-500">No completed Work recorded for this period.</p>
        @else
            <ul class="mt-3 space-y-2">
    ...
    <section class="rounded-xl bg-white p-4 ring-1 ring-inset ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
        ...
        @if (($story['empty_sections']['opportunities'] ?? false) || (($story['opportunities'] ?? []) === []))
            <p class="mt-3 text-sm text-gray-500">No Opportunities were recorded for this period.</p>
        @else
            <ul class="mt-3 space-y-2">
