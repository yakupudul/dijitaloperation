<div wire:poll.3s class="contents">
    @if($activeCount > 0)
        <div class="hidden sm:flex min-w-0 items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-xs text-blue-800 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-300" title="{{ implode(' · ', $providers) }}">
