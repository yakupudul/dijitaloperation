...
<div class="space-y-5">
    ...
    @if ($tab === 'relationships')
        ...
        <div class="grid gap-4 lg:grid-cols-2">
            <div class="rounded-xl bg-white p-5 ring-1 ring-inset ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
                <h2 class="text-sm font-semibold text-gray-800 dark:text-white/90">Linked assets</h2>
                <ul class="mt-3 space-y-3">
            ...
            <div class="rounded-xl bg-white p-5 ring-1 ring-inset ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
                <h2 class="text-sm font-semibold text-gray-800 dark:text-white/90">Cross-asset checks</h2>
                <ul class="mt-3 space-y-3">
