<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-start justify-between gap-3">
        <div>
            ...
            <h1 class="mt-2 text-2xl font-bold text-gray-800 dark:text-white/90">AI Control Plane</h1>
            <p class="mt-1 text-sm text-gray-500">Configure provider order for every registered AI route. Credentials stay in Integrations.</p>
        </div>
    ...
    @if ($selectedRoute !== '')
        <form wire:submit="save" class="space-y-4 rounded-xl bg-white p-5 ring-1 ring-inset ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white/90">Provider order</h2>
            ...
            <div class="flex flex-wrap gap-2">
                <x-ta.button type="button" wire:click="addStep" size="sm" variant="outline">Add provider</x-ta.button>
