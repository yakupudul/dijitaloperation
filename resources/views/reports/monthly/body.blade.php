    ...
    @foreach ($channelsAvailable as $key => $channel)
        <section class="mr-section">
            ...
            @if (is_array($channel['series'] ?? null))
                <div class="mr-chart">{!! \App\Services\MonthlyReport\ReportChart::line((array) $channel['series']['current'], (array) $channel['series']['previous'], $channel['series']['metric'].' (günlük)') !!}</div>
