...
| Async execution | YES | YES | PARTIAL | YES | YES | TESTED | Cancellation future; cross-asset still sync; **persistent public UAT host not yet provisioned** (docs/templates ready — `docs/operations/PERSISTENT_UAT.md`) | Database queue + Activity Center on #121; Cloud Meta async smoke done; final human UAT needs `https://uat.dop.moximu.com` |
