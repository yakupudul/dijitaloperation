...
| Google Business Profile | PARTIAL | YES | NO | PARTIAL | NO | PARTIAL | Reputation Intelligence PLANNED; operator workspace isolates active binding evidence; reviews/performance/local-rank/media remain unavailable | Location profile collector present |
