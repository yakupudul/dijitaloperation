...
/**
 * UI-facing readiness/coverage gate for Meta Ads datasets (Prompt 31).
 */
final class MetaAdsUiDatasetGate
{
    public const string PROVIDER = 'META_ADS';
    ...
    public function evaluateSnapshot(
        ...
        return new MetaAdsDatasetReadiness(
            ...
            coverageState: $covered ? MetaAdsDatasetReadiness::COVERAGE_FULLY_COVERED : MetaAdsDatasetReadiness::COVERAGE_NOT_COVERED,
            coveredDates: [],
            effectiveStart: null,
            effectiveEnd: null,
    ...
    {
        $none = [
            'state' => MetaAdsDatasetReadiness::COVERAGE_NOT_COVERED,
            'dates' => [],
        ...
        return [
            'state' => $gaps === []
                ? MetaAdsDatasetReadiness::COVERAGE_FULLY_COVERED
                : MetaAdsDatasetReadiness::COVERAGE_PARTIALLY_COVERED,
            'dates' => $inRange,
