    ...
    private function pmaxAssetDaily(array $row): ?array
    {
        ...
        return array_merge($base, [
            ...
            'metadata' => [
                ...
                'asset_name' => data_get($row, 'asset.name'),
                'asset_type' => data_get($row, 'asset.type'),
                'asset_text' => data_get($row, 'asset.textAsset.text') ?? data_get($row, 'asset.text_asset.text'),
                'asset_video_title' => data_get($row, 'asset.youtubeVideoAsset.youtubeVideoTitle') ?? data_get($row, 'asset.youtube_video_asset.youtube_video_title'),
