...
/**
 * UI-facing readiness/coverage gate for Google Ads datasets (Prompt 30).
 */
final class GoogleAdsUiDatasetGate
{
    ...
    private function evaluateCoverage(?DatasetMaterialization $materialization, string $start, string $end): array
    {
        ...
        return [
            'state' => $gaps === []
                ? GoogleAdsDatasetReadiness::COVERAGE_FULLY_COVERED
                : GoogleAdsDatasetReadiness::COVERAGE_PARTIALLY_COVERED,
            'dates' => $inRange,
