...
/**
 * Per-dataset UI readiness verdict for a Google Ads (digital_asset_id,
 * external_resource_id, dataset_id) triple over a requested date range.
 */
final class GoogleAdsDatasetReadiness
{
