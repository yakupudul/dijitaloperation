...
/**
 * Machine-readable Opportunity Rule. Trusted application config — never request input.
 *
 * @phpstan-type Condition array{
 *     type: string,
 *     finding_rule_stable_id?: string,
 *     path?: string,
 *     current_path?: string,
...
final class OpportunityRule
{
     ...
     * @param  list<string>  $findingRuleStableIds
     * @param  list<string>  $allowedFindingStates
     * @param  list<string>  $serviceDefinitionCodes
    ...
    public function __construct(
        ...
        public readonly string $qualitativePriorityPolicy,
        public readonly string $sourceModule,
        public readonly array $evidenceDefinitionIds,
        public readonly array $findingRuleStableIds,
        public readonly array $allowedFindingStates,
        ...
        public readonly array $serviceDefinitionCodes,
        public readonly string $serviceScopePolicy,
        ...
        public readonly bool $includeMarketInFingerprint,
    ...
    public static function fromArray(array $raw): self
    {
        ...
        return new self(
            ...
            category: (string) ($raw['category'] ?? 'visibility'),
            qualitativePriority: (string) ($raw['qualitative_priority'] ?? 'medium'),
            qualitativePriorityPolicy: (string) ($raw['qualitative_priority_policy'] ?? 'static'),
            sourceModule: (string) ($raw['source_module'] ?? ''),
            evidenceDefinitionIds: array_values(array_map('strval', $raw['evidence_definition_ids'] ?? [])),
            findingRuleStableIds: array_values(array_map('strval', $raw['finding_rule_stable_ids'] ?? [])),
            allowedFindingStates: array_values(array_map('strval', $raw['allowed_finding_states'] ?? ['open', 'acknowledged'])),
            subject: [
            ...
            cardinality: [
                ...
                'bound' => (string) ($cardinality['bound'] ?? 'one_opportunity_per_asset'),
            ],
            ...
            reopenPolicy: (string) ($raw['reopen_policy'] ?? 'REOPEN_SAME_OPPORTUNITY'),
            ...
            serviceDefinitionCodes: array_values(array_map('strval', $raw['service_definition_codes'] ?? [])),
            serviceScopePolicy: (string) ($raw['service_scope_policy'] ?? 'context_only_outside_allowed'),
            goalOfferingPolicy: (string) ($raw['goal_offering_policy'] ?? 'inherit_explicit_evidence_or_finding_scope_do_not_infer'),
            ...
            includeMarketInFingerprint: (bool) ($raw['include_market_in_fingerprint'] ?? false),
            ...
            consumerIntent: (string) ($raw['consumer_intent'] ?? 'operator_opportunity_queue'),
        );
    }
