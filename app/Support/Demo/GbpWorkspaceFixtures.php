...
final class GbpWorkspaceFixtures
{
    ...
    {
        return [
            'profile' => ['value' => '14 / 17', 'label' => '2 need attention'],
            'visibility' => ['value' => '17 / 25', 'label' => 'Top 3 observed points'],
            'reviews' => ['value' => '4.7 ★', 'label' => '326 reviews · 8 need attention'],
            'actions' => [
                'value' => (string) (int) round(1044 * ($f['results_factor'] ?? 1)),
                'label' => 'Website + call + directions · Last 30 days',
            ],
        ];
    }
    ...
    public static function needsAttention(): array
    {
        return [
            [
                ...
                'problem' => 'Phone mismatch',
                'context' => 'Website ↔ GBP',
                'summary' => 'Client input required',
                'why' => 'Entity inconsistency confuses customers and local discovery systems.',
                'evidence' => 'Brand Context + Website +90 312 555 01 01 · GBP +90 312 000 00 00',
                ...
                'source' => 'Derived · Website ↔ GBP comparison',
                'freshness' => 'Observed 2h ago',
                'related_assets' => ['Website', 'Google Business Profile'],
                'brand_context' => 'Canonical phone +90 312 555 01 01',
                'recommendation' => 'Confirm correct public phone and align controlled sources',
                'task' => null,
                'outcome' => null,
                'public_discovery_cta' => true,
            ],
            [
                'id' => 'att-visibility',
                'severity' => 'High',
                'category' => 'Visibility',
                'problem' => 'Local visibility gap',
                'context' => 'Implant · South-west of location',
                'summary' => '7 / 25 points outside Top 3',
                ...
                'freshness' => 'Scan · 12 Aug 14:30',
                'related_assets' => ['Google Business Profile', 'Website'],
                'brand_context' => 'Priority offering · Dental implants',
                'recommendation' => 'Inspect weak geo cells and local content support',
                'task' => null,
                'outcome' => null,
                'public_discovery_cta' => false,
            ],
            [
                'id' => 'att-implant-service',
                'severity' => 'Medium',
                'category' => 'Profile',
                'problem' => 'Implant missing from service representation',
                'context' => 'Brand Offering ↔ GBP',
                ...
                'suggested' => 'Review in Public Discovery before changing GBP externally.',
                'actionability' => 'Client input required',
                'finding_id' => 'gf-implant-service-gap',
                'source' => 'Derived · Brand Context + GBP',
                'freshness' => 'Observed 2h ago',
                'related_assets' => ['Google Business Profile', 'Website'],
                'brand_context' => 'Priority Offering · Dental implants',
                'recommendation' => 'Review GBP service configuration (external edit outside MoxDOP)',
                'task' => null,
                'outcome' => null,
                'public_discovery_cta' => true,
            ],
            [
                ...
                'severity' => 'Medium',
                'category' => 'Reviews',
                'problem' => '8 reviews need attention',
                'context' => 'Waiting time theme recurring',
                'summary' => 'Agency can fix',
                ...
                'source' => 'Provider + Demo AI analysis',
                'freshness' => 'Reviews refreshed 2h ago',
                'related_assets' => ['Google Business Profile'],
                'brand_context' => null,
                'recommendation' => 'Clear unanswered review backlog',
                'task' => 'Clear unanswered GBP review backlog',
                'outcome' => null,
                'public_discovery_cta' => false,
            ],
        ];
    ...
    {
        return [
            ['field' => 'Business name', 'state' => 'Match', 'brand' => 'Atlas Dental Ankara', 'website' => 'Atlas Dental Ankara', 'gbp' => 'Atlas Dental Ankara'],
            ['field' => 'Phone', 'state' => 'Conflict', 'brand' => '+90 312 555 01 01', 'website' => '+90 312 555 01 01', 'gbp' => '+90 312 000 00 00'],
            ['field' => 'Address', 'state' => 'Match', 'brand' => 'Çankaya, Ankara', 'website' => 'Çankaya, Ankara', 'gbp' => 'Çankaya, Ankara'],
            ['field' => 'Website URL', 'state' => 'Match', 'brand' => 'atlasdental.example', 'website' => 'atlasdental.example', 'gbp' => 'atlasdental.example'],
            ['field' => 'Opening hours', 'state' => 'Needs review', 'brand' => 'Not configured', 'website' => 'Mon–Sat 09:00–19:00', 'gbp' => 'Mon–Sat 09:00–18:30'],
            ['field' => 'Services', 'state' => 'Partial', 'brand' => 'Dental implants priority', 'website' => 'Implant listed', 'gbp' => 'Implant not clearly listed'],
            ['field' => 'Location page', 'state' => 'Match', 'brand' => 'Çankaya', 'website' => '/subeler/cankaya/', 'gbp' => 'Çankaya location'],
            ['field' => 'LocalBusiness data', 'state' => 'Partial', 'brand' => '—', 'website' => 'Partial schema', 'gbp' => 'Provider present'],
        ];
    }
    ...
    public static function opportunities(): array
    {
        return [
            [
                'priority' => 'High',
                'title' => 'Local intent · Çankaya implant',
                'visibility' => 'Weak',
                'website' => 'Partial',
                'gbp_service' => 'Present',
                'why' => 'Priority offering + weak south-west ranks + thin local Implant support content.',
    ...
    public static function recentOutcomes(): array
    {
        return [
            [
                'title' => 'GBP phone differs from Brand Context',
                'chain' => 'Finding → Recommendation → Task · awaiting client confirmation',
                'outcome' => 'Still observed',
                'note' => 'GBP still shows +90 312 000 00 00 vs canonical +90 312 555 01 01 — no causal claim; difference retained for Public Discovery review.',
            ],
            [
    ...
    public static function profile(): array
    {
        return [
            ...
            'fields' => [
                ...
                ['area' => 'Phone', 'value' => '+90 312 000 00 00', 'state' => 'Needs attention', 'evidence' => 'GBP vs Brand Context / Website', 'action' => 'Review in Public Discovery'],
    ...
    public static function operations(): array
    {
        return [
            ...
            'findings' => [
                ['id' => 'gf-phone-mismatch', 'severity' => 'high', 'category' => 'Public identity', 'title' => 'GBP phone number differs from Brand Context and Website', 'status' => 'open'],
            ...
            'outcomes' => [
                ['task' => 'Confirm correct phone and update controlled sources', 'state' => 'Still observed', 'note' => 'GBP still differs from Brand Context / Website — retained for Public Discovery review.'],
            ...
            'finding_detail' => [
                'gf-phone-mismatch' => [
                    'what' => 'GBP lists +90 312 000 00 00 while Brand Context and Website primary contact show +90 312 555 01 01.',
                    'where' => 'GBP contact · Website /contact · Brand Context',
                    'why' => 'Public entity inconsistency reduces trust and confuses local discovery.',
                    'evidence' => 'Normalized phone comparison · Brand Context ↔ Website ↔ GBP',
                    'affected' => 'Contact entity',
                    'owner' => 'Client + Agency',
                    'next' => 'Confirm canonical phone; align controlled sources (GBP external edit outside MoxDOP). Review in Public Discovery.',
