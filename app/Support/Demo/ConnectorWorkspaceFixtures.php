...
final class ConnectorWorkspaceFixtures
{
        ...
        return self::base(
            ...
            resources: [
                [
                    ...
                    'asset_route' => 'demo.google-ads.overview',
            ...
            data: [
                ...
                'asset_cta' => ['label' => 'Open Google Ads Digital Asset →', 'route' => 'demo.google-ads.overview', 'params' => []],
            ],
            sync: [
                'last_success' => '1h ago',
                'last_attempt' => '1h ago',
    ...
    public static function ga4(): array
    {
        return self::base(
            ...
            data: [
                ...
                'asset_cta' => ['label' => 'Open Google Analytics Digital Asset →', 'route' => 'demo.analytics', 'params' => []],
            ],
            sync: [
                'last_success' => '1h ago',
                'last_attempt' => '1h ago',
        ...
        return self::base(
            ...
            resources: [
                [
                    ...
                    'asset_route' => 'demo.search-console',
            ...
            data: [
                ...
                'asset_cta' => ['label' => 'Open Search Console Digital Asset →', 'route' => 'demo.search-console', 'params' => []],
            ],
            sync: [
                'last_success' => '2h ago',
                'last_attempt' => '2h ago',
    ...
    public static function gbp(): array
    {
        return self::base(
            ...
            data: [
                ...
                'asset_cta' => ['label' => 'Open Google Business Profile Digital Asset →', 'route' => 'demo.gbp', 'params' => []],
            ],
            sync: [
                'last_success' => '2h ago',
                'last_attempt' => '2h ago',
        ...
        return self::base(
            ...
            resources: [
                [
                    ...
                    'asset_route' => 'demo.meta.overview',
            ...
            data: [
                ...
                'asset_cta' => ['label' => 'Open Meta Ads Digital Asset →', 'route' => 'demo.meta.overview', 'params' => []],
            ],
            sync: [
    ...
    private static function base(
        ...
        return [
            ...
            'integration_route' => $integration === 'google' ? 'demo.integrations.google' : 'demo.integrations.meta',
            'name' => $name,
            'type' => $type,
