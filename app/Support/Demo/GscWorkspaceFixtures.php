...
final class GscWorkspaceFixtures
{
    ...
    public static function workspace(string $preset = 'last_28', ?string $start = null, ?string $end = null): array
    {
        ...
        return [
            ...
            'pages' => [
                'subtitle' => 'Which Website content captures organic demand and how search visibility relates to Website performance.',
                'directory' => self::pagesDirectory($totals),
                'attribution_note' => 'GA4 context is page-level across all sources — not query→conversion attribution.',
            ],
    ...
    public static function glance(array $totals, array $compare, array $f): array
    {
        ...
        return [
            ...
            'search_attention' => [
                'value' => '4 items',
                'raw' => 4,
                'secondary' => 'Needs attention · '.$f['label'],
                'tone' => 'warning',
                'note' => 'Operational signals — not a quality score.',
            ],
        ];
    }
    ...
    public static function pagePulse(array $totals): array
    {
        ...
        foreach (self::PAGES as $path => $meta) {
            ...
            $rows[] = [
                'id' => 'page-'.ltrim(str_replace('/', '-', $path), '-') ?: 'home',
                'path' => $path,
                'title' => $meta['title'],
                'content_role' => $meta['role'],
                'offering' => $meta['offering'],
                'clicks' => $pageClicks,
                'impressions' => (int) round($pageClicks / max(0.005, ($totals['ctr'] ?? 0.021))),
                'trend' => $trendPct >= 5 ? 'Growing' : ($trendPct <= -10 ? 'Review' : 'Stable'),
                'trend_pct' => $trendPct,
                'cluster_count' => match ($path) {
                    '/implant' => 14,
                    '/' => 26,
                    '/post-bariatric' => 9,
                    '/blog/implant-bakimi' => 5,
                    '/contact' => 4,
                    default => 3,
                },
                'clusters' => match ($path) {
        ...
        return [
            ...
            'ownership_reviews' => [
                [
                    ...
                    'intended_page' => '/implant',
                    'intended_source' => 'Brand Context · Website offering',
                    'observed' => [
                        ['path' => '/implant', 'share_pct' => 54],
                        ['path' => '/', 'share_pct' => 24],
                        ['path' => '/blog/implant-bakimi', 'share_pct' => 17],
                        ['path' => 'Other', 'share_pct' => 5],
                    ],
                    'urls' => ['/implant', '/', '/blog/implant-bakimi'],
                    'state' => 'Search ownership fragmented',
                    'language' => 'Cannibalization candidate — not proven cannibalization',
                    'recommendation' => 'Clarify intended owner and internal linking — MoxDOP internal strategy only.',
                ],
            ],
            'observed_query_note' => 'Queries observed in selected Search Console dataset — not an exhaustive keyword universe.',
        ];
    }
        ...
        return [
            ...
            'urls' => [
                [
                    'id' => 'url-home',
                    'path' => '/',
                    'url' => 'https://atlasdental.example/',
                    'role' => 'Home',
                    'sitemap' => 'Present',
                    'index_state' => 'Indexed',
                    'last_crawl' => '11 Aug 2026',
                    'canonical' => 'Match',
                    'search_visibility' => 'Observed',
                    'attention' => null,
                ],
                [
                    'id' => 'url-implant',
                    'path' => '/implant',
                    'url' => 'https://atlasdental.example/implant',
                    'role' => 'Service / Product',
                    'sitemap' => 'Present',
                    'index_state' => 'Indexed',
                    'last_crawl' => '10 Aug 2026',
                    'canonical' => 'Mismatch',
                    'user_canonical' => '/implant',
                    'google_canonical' => '/dental-implant',
                    'search_visibility' => 'Observed',
                    'attention' => 'Canonical selection differs',
                ],
                [
                    'id' => 'url-post-bariatric',
                    'path' => '/post-bariatric',
                    'url' => 'https://atlasdental.example/post-bariatric',
                    'role' => 'Service / Product',
                    'sitemap' => 'Present',
                    'index_state' => 'Indexed',
                    'last_crawl' => '10 Aug 2026',
                ...
                [
                    'id' => 'url-contact',
                    'path' => '/contact',
                    'url' => 'https://atlasdental.example/contact',
                    'role' => 'Conversion / Contact',
                    'sitemap' => 'Missing',
                    'index_state' => 'Indexed',
                    'last_crawl' => '09 Aug 2026',
                    'canonical' => 'Match',
                    'search_visibility' => 'Observed',
                    'attention' => 'Priority page absent from sitemap evidence',
                ],
                [
                    'id' => 'url-team',
                    'path' => '/team',
                    'url' => 'https://atlasdental.example/team',
                    'role' => 'Team / Expert',
                    'sitemap' => 'Present',
                    'index_state' => 'Indexed',
                    'last_crawl' => '08 Aug 2026',
                    'canonical' => 'Match',
                    'search_visibility' => 'No observed impressions',
                    'attention' => 'Informational · not an indexing failure',
                ],
                [
                    'id' => 'url-blog',
                    'path' => '/blog/implant-bakimi',
                    'url' => 'https://atlasdental.example/blog/implant-bakimi',
                    'role' => 'Content / Blog',
                    'sitemap' => 'Present',
                    'index_state' => 'Indexed',
                    'last_crawl' => '09 Aug 2026',
                ...
                [
                    'id' => 'url-unknown',
                    'path' => '/old-landing',
                    'url' => 'https://atlasdental.example/old-landing',
                    'role' => 'Legacy',
                    'sitemap' => 'Missing',
                    'index_state' => 'Unavailable',
                    'last_crawl' => '—',
                    'canonical' => 'Unknown',
                    'search_visibility' => 'Unavailable',
                    'attention' => 'Index evidence unavailable',
                ],
            ],
            'sitemaps' => [
                ['path' => '/sitemap.xml', 'submitted' => '01 Aug 2026', 'last_downloaded' => '12 Aug 2026', 'discovered' => 184, 'warnings' => 0, 'errors' => 0, 'status' => 'Success'],
                ['path' => '/sitemap-blog.xml', 'submitted' => '01 Aug 2026', 'last_downloaded' => '12 Aug 2026', 'discovered' => 8, 'warnings' => 0, 'errors' => 0, 'status' => 'Success'],
            ],
            'reconciliation' => [
                'website_urls' => 191,
                'sitemap_urls' => 184,
                'index_observed' => 57,
                'priority_missing_sitemap' => 1,
                'gaps' => [
                    '7 Website inventory URLs not in submitted sitemap evidence',
                    'Priority /contact absent from sitemap',
                    '3 indexed URLs with no impressions in current window — not deindexed claims',
                ],
            ],
            'discoverability_by_role' => [
                ['role' => 'Service pages', 'with_impressions' => 31, 'inventory' => 34],
                ['role' => 'Location pages', 'with_impressions' => 8, 'inventory' => 12],
                ['role' => 'Articles', 'with_impressions' => 42, 'inventory' => 91],
                ['role' => 'FAQ', 'with_impressions' => 12, 'inventory' => 24],
            ],
            'inspection_note' => 'Google index state · Demo fixtures — not a Live URL test. No Force Index / Request Index actions.',
        ];
    }
