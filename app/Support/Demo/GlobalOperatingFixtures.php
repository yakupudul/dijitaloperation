            ...
            [
                ...
                'providers' => [
                    ...
                    [
                        ...
                        'last_check' => '—',
                        'dependent_assets' => 0,
                        'note' => 'Ücretsiz / düşük maliyetli açık modeller; müşteri verisi içeren işlere atanmaz.',
                        'route' => 'operator.integrations.ai',
                        'route_params' => ['provider' => 'groq'],
                        'manage_label' => 'Configure',
                    ],
                    [
                        'id' => 'openrouter',
                        ...
                        'last_check' => '—',
                        'dependent_assets' => 0,
                        'note' => 'Birçok modele tek anahtarla erişim; müşteri verisi içeren işlere atanmaz.',
                        'route' => 'operator.integrations.ai',
                        'route_params' => ['provider' => 'openrouter'],
                        'manage_label' => 'Configure',
                    ],
                ],
            ],
    ...
    public static function settingsPayload(): array
    {
        return [
            ...
            'notifications' => [
                ...
                ['event' => 'Work item overdue', 'channel' => 'In-app', 'enabled' => true],
                ['event' => 'Client request received', 'channel' => 'In-app', 'enabled' => true],
                ['event' => 'Approval waiting', 'channel' => 'In-app', 'enabled' => true],
                ['event' => 'QA review required', 'channel' => 'In-app', 'enabled' => true],
                ['event' => 'Recurring review due', 'channel' => 'In-app', 'enabled' => true],
