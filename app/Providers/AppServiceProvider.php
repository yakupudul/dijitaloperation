...
use App\Services\IntelligenceMemory\DeferredSectorLearningPrivacyGate;
...
use App\Services\IntelligenceMemory\NullBrandMemoryContextProvider;
use App\Services\IntelligenceMemory\NullSectorMemoryContextProvider;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(SectorLearningPrivacyGate::class, DeferredSectorLearningPrivacyGate::class);
        $this->app->singleton(BrandMemoryContextProvider::class, NullBrandMemoryContextProvider::class);
        $this->app->singleton(SectorMemoryContextProvider::class, NullSectorMemoryContextProvider::class);
