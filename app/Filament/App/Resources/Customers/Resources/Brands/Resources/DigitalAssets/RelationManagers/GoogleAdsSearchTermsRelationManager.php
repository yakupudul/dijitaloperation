...
class GoogleAdsSearchTermsRelationManager extends RelationManager
{
    protected static string $relationship = 'runs';

    protected static ?string $title = 'Search terms';
    ...
    public function content(Schema $schema): Schema
    {
        ...
        return $schema->components([
            View::make('google-ads::workspace.search-terms')
                ->viewData([
