...
class GoogleAdsIntelligenceRelationManager extends RelationManager
{
    ...
    public function content(Schema $schema): Schema
    {
        ...
        return $schema->components([
            View::make('google-ads::workspace.intelligence')
                ->viewData([
    ...
    public function acceptAiRecommendationDraft(int $findingId): void
    {
        ...
        try {
            $result = app(GoogleAdsAiRecommendationAcceptance::class)->acceptDraft($asset, $findingId);
