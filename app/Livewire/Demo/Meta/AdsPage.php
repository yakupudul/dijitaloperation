...
class AdsPage extends Component
{
    ...
    public function mount(string $assetId): void
    {
        ...
        $this->mountPeriod();
        $stored = DemoState::getFilter('meta_ad_status');
    ...
    public function setStatusFilter(string $status): void
    {
        ...
        DemoState::setFilter('meta_ad_status', $status === 'all' ? null : $status);
    }

    public function render(): View
    {
        $rows = DemoCatalog::metaAdsList($this->period);
        ...
        return view('livewire.demo.meta.ads', [
