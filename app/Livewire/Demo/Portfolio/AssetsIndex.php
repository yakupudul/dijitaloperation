...
class AssetsIndex extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('livewire.demo.portfolio.assets-index', [
            ...
            'operationalOptions' => [
                'active' => __('operator.states.active'),
                'inactive' => __('operator.states.inactive'),
                'archived' => __('operator.states.archived'),
                'setup' => __('operator.states.defined'),
            ],
            'dataStateOptions' => [
                'fresh' => __('operator.states.fresh'),
                'stale' => __('operator.states.stale'),
                'unavailable' => __('operator.states.not_collected'),
                'not_applicable' => __('operator.states.not_applicable'),
            ],
            'healthOptions' => [
                'healthy' => __('operator.states.defined'),
                'needs_attention' => __('operator.states.needs_attention'),
                'warning' => __('operator.states.needs_attention'),
            ],
            'roleOptions' => [
                'primary_managed' => app()->getLocale() === 'tr' ? 'Yönetilen varlık' : 'Primary managed asset',
                'connected_source' => app()->getLocale() === 'tr' ? 'Bağlı veri kaynağı' : 'Connected data source',
                'infrastructure' => app()->getLocale() === 'tr' ? 'Eski altyapı (kullanılmıyor)' : 'Legacy infrastructure (deprecated)',
            ],
