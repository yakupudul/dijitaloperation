...
final class MethodLibraryPage extends Component
{
    ...
    public const array ADVISOR_RULES = [
        'google_ads' => ['negative-keywords', 'ngram-waste', 'service-terms-not-converting', 'keyword-opportunities', 'budget-limited-profitable', 'budget-waste', 'auto-tagging-off', 'no-primary-conversion', 'primary-no-signal', 'conversion-settings', 'ga4-mismatch', 'landing-page-issues', 'landing-keyword-mismatch', 'weak-ad-strength', 'missing-assets', 'google-recommendations', 'low-quality-score', 'quality-score-drop', 'performance-anomaly', 'daily-anomaly', 'change-impact', 'negative-keyword-conflict', 'segment-bid-adjustment'],
